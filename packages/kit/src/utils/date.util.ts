...
type DiffUnit = 'day' | 'hour' | 'minute' | 'second' | 'millisecond'
 ...
 * @returns 差值（绝对值）
 */
export function diffTime(date1: DateInput, date2: DateInput, unit: DiffUnit = 'day'): number {
 ...
 * @returns TZDate 对象
 */
export function toTimeZone(date: DateInput, timeZone: string): TZDate {
...
export { tz, TZDate } from '@date-fns/tz'
