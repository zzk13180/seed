...
import type { Alignment as ScrollStrategy } from '@seed/element-plus-components/virtual-list'
...
export const useScrollbar = (
  props: TableV2Props,
  { mainTableRef, leftTableRef, rightTableRef, onMaybeEndReached }: UseScrollBarProps,
) => {
