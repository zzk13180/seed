...
const DynamicSizeGrid = createGrid({
  ...
  getColumnOffset: (props, columnIndex, alignment, scrollLeft, cache, scrollBarWidth) =>
    getOffset(props, columnIndex, alignment, scrollLeft, cache, 'column', scrollBarWidth),

  getRowOffset: (props, rowIndex, alignment, scrollTop, cache, scrollBarWidth: number) =>
  ...
  injectToInstance: (instance, cache) => {
    const resetAfter = ({ columnIndex, rowIndex }: Indices, forceUpdate?: boolean) => {
