...
<script lang="ts" setup>
  ...
  const updateSelect = () => {
    ...
    const selectedItem = segmentedRef.value.querySelector('.is-selected') as HTMLElement
    const selectedItemInput = segmentedRef.value.querySelector('.is-selected input') as HTMLElement
