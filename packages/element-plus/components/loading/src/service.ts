...
const addStyle = async (
  ...
  const { nextZIndex } =
    ((instance.vm as any).zIndex as UseZIndexReturn) || (instance.vm as any)._.exposed.zIndex
...
const addClassList = (options: LoadingOptions, parent: HTMLElement, instance: LoadingInstance) => {
  // Compatible with the instance data format of vue@3.2.12 and earlier versions #12351
  const ns = ((instance.vm as any).ns as UseNamespaceReturn) || (instance.vm as any)._.exposed.ns
