...
export const treeEmits = {
  ...
  [NODE_DROP]: (data: TreeNodeData, node: TreeNode, e: DragEvent) => data && node && e,
  ...
  [NODE_CHECK_CHANGE]: (data: TreeNodeData, checked: boolean) => data && isBoolean(checked),
  [NODE_CONTEXTMENU]: (evt: Event, data: TreeNodeData, node: TreeNode) => evt && data && node,
}
