...
export function useDragTag({ wrapperRef, handleDragged, afterDragged }: UseDragTagOptions) {
  ...
  function handleDragStart(event: DragEvent, index: number) {
    draggingIndex = index
    draggingTag = wrapperRef.value!.querySelector<HTMLElement>(getTagClassName(index))
  ...
  function handleDragOver(event: DragEvent, index: number) {
    ...
    const innerEl = wrapperRef.value!.querySelector<HTMLElement>(`.${ns.e('inner')}`)!
