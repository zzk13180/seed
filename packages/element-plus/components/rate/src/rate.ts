...
import { buildProps, definePropType, iconPropType, isNumber, mutable } from '@element-plus/utils'
...
export const rateProps = buildProps({
   ...
   */
  icons: {
    type: definePropType<Array<string | Component> | Record<number, string | Component>>([
      Array,
      Object,
    ]),
    default: () => [StarFilled, StarFilled, StarFilled] as [Component, Component, Component],
  },
  /**
