    ...
    >
      ...
      >
        ...
        <template v-if="showDecimalIcon(item)">
          ...
          <el-icon :style="decimalStyle" :class="[ns.e('icon'), ns.e('decimal')]">
...
<script lang="ts" setup>
  ...
  function getValueFromMap<T>(
    ...
    const isExcludedObject = (val: unknown): val is { excluded?: boolean } & Record<any, unknown> =>
      isObject(val)
  ...
  const componentMap = computed(() => {
    ...
    icons = markRaw(icons) as Array<string | Component> | Record<number, string | Component>
