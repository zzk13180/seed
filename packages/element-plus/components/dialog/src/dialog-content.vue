...
<script lang="ts" setup>
  ...
  import { FOCUS_TRAP_INJECTION_KEY } from '@seed/element-plus-components/focus-trap'
  import { useDraggable, useLocale } from '@seed/element-plus-hooks'
  import { CloseComponents, composeRefs } from '@seed/element-plus-utils'
