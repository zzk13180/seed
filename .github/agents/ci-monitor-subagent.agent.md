...
Start polling immediately — no initial wait. The exponential backoff between polls (60s → 90s → 120s cap) handles pacing naturally. The first poll provides immediate feedback on CI state, even if it's NOT_STARTED.
